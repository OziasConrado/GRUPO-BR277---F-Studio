...
const mockSauLocations: SAULocation[] = [
  ...
  { id: 'arb-new-4', concessionaire: 'Arteris Régis Bitencourt', name: 'SAU Km 357 (Sentido Curitiba) - BR-116', address: 'BR-116, Km 357 (sentido Curitiba), Miracatu - SP', latitude: -24.2796, longitude: -47.4612, services: standardSauServices, operatingHours: '24 horas' }, // Same city, different km
  { id: 'arb-new-5', concessionaire: 'Arteris Régis Bitencourt', name: 'SAU Km 370 (Sentido São Paulo) - BR-116', address: 'BR-116, Km 370 (sentido São Paulo), Miracatu - SP', latitude: -24.2700, longitude: -47.4500, services: standardSauServices, operatingHours: '24 horas' }, // Same city, different km
  ...
  { id: 'arb-new-10', concessionaire: 'Arteris Régis Bitencourt', name: 'SAU Km 57 (Sentido Curitiba) - BR-116', address: 'BR-116, Km 57 (sentido Curitiba), Campina Grande do Sul - PR', latitude: -25.2000, longitude: -48.8000, services: standardSauServices, operatingHours: '24 horas' }, // Approx
  ...
  { id: 'ccr-prvias-3', concessionaire: 'CCR PRVias', name: 'SAU Km 181 (Norte) - BR-373', address: 'BR-373 – Rodovia do Café Governador Ney Braga, km 181 (Sentido Norte), Ponta Grossa - PR', latitude: -25.1567, longitude: -50.1039, services: ccrPrviasServices, operatingHours: '24 horas' }, 
  { id: 'ccr-prvias-4', concessionaire: 'CCR PRVias', name: 'SAU Km 511 (Norte) - BR-376/PR', address: 'BR-376/PR - Rodovia do Café Governador Ney Braga, km 511 (Sentido Norte), Ponta Grossa - PR', latitude: -24.9980, longitude: -50.1592, services: ccrPrviasServices, operatingHours: '24 horas' }, 
  ...
  { id: 'ccr-prvias-6', concessionaire: 'CCR PRVias', name: 'SAU Km 26 (Norte) - PR-445', address: 'PR-445 - Rodovia Celso Garcia Cid, km 26 (Sentido Norte), Londrina - PR', latitude: -23.4215, longitude: -51.1851, services: ccrPrviasServices, operatingHours: '24 horas' }, 
  { id: 'ccr-prvias-7', concessionaire: 'CCR PRVias', name: 'SAU Km 59 (Norte) - PR-445', address: 'PR-445 - Rodovia Celso Garcia Cid, km 59 (Sentido Norte), Londrina - PR', latitude: -23.3379, longitude: -51.1707, services: ccrPrviasServices, operatingHours: '24 horas' }, 
  ...
  { id: 'ccr-prvias-9', concessionaire: 'CCR PRVias', name: 'SAU Km 54 (Sul) - PR-323', address: 'PR-323 – Rodovia Celso Garcia Cid, km 54 (Sentido Sul), Sertanópolis - PR', latitude: -23.0700, longitude: -50.8000, services: ccrPrviasServices, operatingHours: '24 horas' }, 
  ...
  // CCR RioSP - Updated Entries (21 new)
  { id: 'ccr-rsp-new-1', concessionaire: 'CCR RioSP', name: 'SAU Km 98.9 (Sul) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 98,900 - Sentido Rio - SP (Sul), Pindamonhangaba - SP', latitude: -22.9231, longitude: -45.4563, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-2', concessionaire: 'CCR RioSP', name: 'SAU Km 51.2 (Norte) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 51,200 - Sentido SP - Rio (Norte), Lorena - SP', latitude: -22.7319, longitude: -45.1242, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-3', concessionaire: 'CCR RioSP', name: 'SAU Km 202 (Norte) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 202 - Sentido SP - Rio (Norte), Arujá - SP', latitude: -23.3961, longitude: -46.3194, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-4', concessionaire: 'CCR RioSP', name: 'SAU Km 117.5 (Norte) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 117,5 - Sentido SP - Rio (Norte), Taubaté - SP', latitude: -23.0267, longitude: -45.5558, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-5', concessionaire: 'CCR RioSP', name: 'SAU Km 156.2 (Sul) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 156,200 - Sentido Rio - SP (Sul), São José dos Campos - SP', latitude: -23.1792, longitude: -45.8869, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-6', concessionaire: 'CCR RioSP', name: 'SAU Km 264.6 (Sul) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 264,600 - Sentido Rio - SP (Sul), Volta Redonda - RJ', latitude: -22.5230, longitude: -44.1042, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-7', concessionaire: 'CCR RioSP', name: 'SAU Km 233.7 (Norte) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 233,700 - Sentido SP - Rio (Norte), Piraí - RJ', latitude: -22.6292, longitude: -43.8984, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-8', concessionaire: 'CCR RioSP', name: 'SAU Km 297.7 (Norte) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 297,700 - Sentido SP - Rio (Norte), Porto Real - RJ', latitude: -22.4197, longitude: -44.2908, services: ccrPrviasServices, operatingHours: '24 horas' }, // Corrected Porto Real to RJ
  { id: 'ccr-rsp-new-9', concessionaire: 'CCR RioSP', name: 'SAU Km 230.2 (Sul) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 230,200 - Sentido Rio - SP (Sul), São Paulo - SP', latitude: -23.4969, longitude: -46.5413, services: ccrPrviasServices, operatingHours: '24 horas' }, // Approx. for SP entry
  { id: 'ccr-rsp-new-10', concessionaire: 'CCR RioSP', name: 'SAU Km 18.3 (Norte) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 18,300 - Sentido SP - Rio (Norte), Lavrinhas - SP', latitude: -22.5708, longitude: -44.9031, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-11', concessionaire: 'CCR RioSP', name: 'SAU Km 316.7 (Sul) - BR-116 (Via Dutra)', address: 'BR-116 (Via Dutra), Km 316,700 - Sentido Rio - SP (Sul), Itatiaia - RJ', latitude: -22.4964, longitude: -44.5636, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-12', concessionaire: 'CCR RioSP', name: 'SAU Km 471 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 471 - Sentido RJ (Norte), Angra dos Reis - RJ', latitude: -23.0069, longitude: -44.3183, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-13', concessionaire: 'CCR RioSP', name: 'SAU Km 10 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 10 - Sentido RJ (Norte), Ubatuba - SP', latitude: -23.4339, longitude: -45.0711, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-14', concessionaire: 'CCR RioSP', name: 'SAU Km 497 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 497 - Sentido RJ (Norte), Angra dos Reis - RJ', latitude: -22.9000, longitude: -44.2000, services: ccrPrviasServices, operatingHours: '24 horas' }, // Approx
  { id: 'ccr-rsp-new-15', concessionaire: 'CCR RioSP', name: 'SAU Km 31 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), km 31 - Sentido RJ (Norte), Ubatuba - SP', latitude: -23.3000, longitude: -44.9000, services: ccrPrviasServices, operatingHours: '24 horas' }, // Approx
  { id: 'ccr-rsp-new-16', concessionaire: 'CCR RioSP', name: 'SAU Km 550 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 550 - Sentido RJ (Norte), Paraty - RJ', latitude: -23.2194, longitude: -44.7153, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-17', concessionaire: 'CCR RioSP', name: 'SAU Km 451 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 451 - Sentido RJ (Norte), Mangaratiba - RJ', latitude: -22.9597, longitude: -44.0406, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-18', concessionaire: 'CCR RioSP', name: 'SAU Km 417 (Norte) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 417 - Sentido RJ (Norte), Mangaratiba - RJ', latitude: -22.9000, longitude: -43.9000, services: ccrPrviasServices, operatingHours: '24 horas' }, // Approx
  { id: 'ccr-rsp-new-19', concessionaire: 'CCR RioSP', name: 'SAU Km 392 (Sul) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 392 - Sentido SP (Sul), Itaguaí - RJ', latitude: -22.8519, longitude: -43.7758, services: ccrPrviasServices, operatingHours: '24 horas' },
  { id: 'ccr-rsp-new-20', concessionaire: 'CCR RioSP', name: 'SAU Km 579 (Sul) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 579 - Sentido SP (Sul), Paraty - RJ', latitude: -23.1000, longitude: -44.6000, services: ccrPrviasServices, operatingHours: '24 horas' }, // Approx
  { id: 'ccr-rsp-new-21', concessionaire: 'CCR RioSP', name: 'SAU Km 527 (Sul) - BR-101 (Rio Santos)', address: 'BR-101 (Rio Santos), Km 527 - Sentido SP (Sul), Angra dos Reis - RJ', latitude: -22.8000, longitude: -44.1000, services: ccrPrviasServices, operatingHours: '24 horas' }, // Approx
...
].filter(sau => !(sau.concessionaire === 'CCR RioSP' && (sau.id === 'ccr-rsp-1' || sau.id === 'ccr-rsp-2'))); // Remove old CCR RioSP entries
