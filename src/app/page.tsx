            ...
            <Card className="rounded-lg">
                <CardContent className="p-2 grid grid-cols-3 gap-2">
                    <Button asChild variant="outline" className="h-full flex-col py-2 rounded-md hover:bg-primary/5">
                        <Link href="/streaming">
                            <svg className="h-6 w-6 text-primary mb-1" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M14 17.02V19c1.1 0 2-.9 2-2h-2zM4 11V8c0-.55.45-1 1-1h6c.55 0 1 .45 1 1v3c0 .55-.45 1-1 1H5c-.55 0-1-.45-1-1zm14.79-1.21-3.43-2.05c-.4-.23-.89.11-.89.59v6.14c0 .48.49.82.89.59l3.43-2.05c.39-.23.39-.81 0-1.04zM18 10.5v3" />
                            </svg>
                            <span className="text-xs font-semibold text-center leading-tight">Câmeras AO VIVO</span>
                        </Link>
                    </Button>
                     <Button variant="outline" className="h-full flex-col py-2 rounded-md hover:bg-primary/5" onClick={openChat}>
                        ...
                        <span className="text-xs font-semibold text-center leading-tight">Comunidade277</span>
                    </Button>
                    <Button asChild variant="outline" className="h-full flex-col py-2 rounded-md hover:bg-primary/5">
                        <Link href="/sau">
                            <Headset className="h-6 w-6 text-primary mb-1"/>
                            <span className="text-xs font-semibold text-center leading-tight">Concessões/SAU</span>
                        </Link>
                    </Button>
                </CardContent>
            </Card>
