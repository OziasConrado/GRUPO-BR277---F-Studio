  ...
  const handleDownloadPdf = () => {
    ...
    printWindow?.document.write(`
      <style>
        ...
        h1 { color: #002776; border-bottom: 2px solid #002776; padding-bottom: 5px; font-size: 1.8em; }
        h2 { color: #0056b3; margin-top: 20px; font-size: 1.4em; }
        h3 { margin-bottom: 2px; font-size: 1.1em; }
        p { margin: 0.3em 0; }
        img { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; margin-bottom: 15px; border: 2px solid #002776; }
    ...
    printWindow?.document.write(generatedCurriculoHtml);
